    ...
    public static boolean applyPlan(String grid, String solution) {
        ...
        for (int i = 0; i < actions.length; i++) {
            ...
            switch (actions[i]) {
                case "up":
                    linkin = s.f2();
                    System.out.println("action "+i+" up is "+ linkin);
                    break;
                case "down":
                    linkin = s.f3();
                    System.out.println("action "+i+" down is "+ linkin);
                    break;
                case "right":
                    linkin = s.f4();
                    System.out.println("action "+i+" right is "+ linkin);
                    break;
                case "left":
                    linkin = s.applyLeft();
                    System.out.println("action "+i+" left is "+ linkin);
                    break;
                case "carry":
                    linkin = s.f209();
                    System.out.println("action "+i+" carry is "+ linkin);
                    break;
                case "drop":
                    linkin = s.f220();
                    System.out.println("action "+i+" drop is "+ linkin);
                    break;
                case "fly":
                    linkin = s.f320();
                    System.out.println("action "+i+" fly is "+ linkin);
                    break;
                case "takePill":
                    linkin = s.f32();
                    System.out.println("action "+i+" take pill is "+ linkin);
                    break;
                case "kill":
                    linkin = s.f100();
                    System.out.println("action "+i+" kill is "+ linkin);
                    break;
